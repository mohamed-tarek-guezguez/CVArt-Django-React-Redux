...
const Cv1 = ({myBgColor, myColor, user}) => {
    ...
    return (
        ...
        <div className="container card p-0 rounded grid__container" style={{ borderRadius: '4px 0 0 4px' }}>
            <div className="sidebar" style={{ backgroundColor: myBgColor, color: myColor, borderRadius: '4px 0 0 4px' }}>
                <div className="user">
                    <center>
                        <img 
                    ...
                    <h1 className="py-2">
                        {
                            isEditable && firstNameEdit
                                ...
                                :(
                                    <p className={isEditable ? 'my-1 py-0 update-info' : 'my-0 py-0'} onDoubleClick={() => setFirstNameEdit(true)}>
                                        {firstNameDetails}
                                    </p>
                                )
                        }
